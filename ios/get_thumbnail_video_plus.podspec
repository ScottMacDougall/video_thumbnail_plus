...
# Run `pod lib lint get_thumbnail_video_plus.podspec` to validate before publishing.
#
Pod::Spec.new do |s|
  s.name             = 'get_thumbnail_video_plus'
  s.version          = '0.0.1'
...
A flutter plugin for creating a thumbnail from a local video file or from a video URL.
  ...
  # s.resource_bundles = {'get_thumbnail_video_plus_privacy' => ['Resources/PrivacyInfo.xcprivacy']}
end
